...
// 1. Fetch contents with EXACT dynamic avg_rating calculation
...
while ($c = $contentsRes->fetch_assoc()) {
    ...
    $c['avg_rating'] = count($reviews) > 0 ? round($totalRating / count($reviews), 1) : 0;

    $contents[] = $c;
}

// Sort contents by avg_rating DESC to match EXACT Trending Today order in local!
...
echo "SUCCESSFULLY EXPORTED ALL MOCK DATA WITH EXACT CALCULATED RATINGS!\n";
