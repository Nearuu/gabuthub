...
// 1. Contents with full relationships
...
echo "SUCCESSFULLY EXPORTED 100% ALL TABLES (CONTENTS:" . count($contents) . ", POLLS:" . count($polls) . ", POSTS:" . count($posts) . ", CHARS:" . count($gameChars) . ", TAKES:" . count($hotTakes) . ") FROM LOCAL MYSQL DATABASE!\n";
